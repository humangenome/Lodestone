...
#
# On this repo the body lives in .github/release-notes/<tag>.md, hand-written
# per release. (LodestoneServer builds its bodies from CHANGELOG.md instead;
# the two use the identical linter on purpose.)
#
# Usage:
