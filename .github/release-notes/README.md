...
The release workflow publishes the matching file verbatim as the release body and **fails if it is missing**, so a release cannot go out with a body nobody wrote.
...
Hosting: [SurvivalServers.com](https://www.survivalservers.com/services/game_servers/delverium/?utm_source=github&utm_medium=release_notes&utm_campaign=lodestone) runs Lodestone for you.
```
